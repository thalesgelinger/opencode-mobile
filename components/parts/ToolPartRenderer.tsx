            ...
            case 'completed':
                ...
                if (shouldShowPreview(output)) {
                    const filename = isFileReadTool(part.tool)
                        ? (inputData?.filePath && typeof inputData.filePath === 'string'
                            ? inputData.filePath.split('/').pop() || 'Output'
                            : 'Output')
                        : `${part.tool} Output`;
